...
export default {
  app: {
    ...
    description_long:
      "Une application pour favoriser un vivre ensemble basé sur l’accueil, la confiance et l’entraide.",
    action: {
      accept: "Accepter",
      ...
      send: "Envoyer",
      send_invitation:
        "Envoyer l'invitation |||| Envoyer %{smart_count} invitations",
    ...
    helper: {
      ...
      addresses_visibility:
        "Les adresses ne sont visibles que des personnes invité à vos rencontres",
      event_draft_mode:
      ...
      no_contact:
        "Vous devez ajouter des contacts à votre réseau pour pouvoir les inviter",
      no_address:
        "Vous devez ajouter au moins une adresse à votre profil avant de pouvoir proposer une rencontre",
      other_conditions:
        "Vous pouvez entrer plusieurs conditions supplémentaires (une par ligne)",
      organized_events_visibility:
        "Seules les rencontres auxquelles vous avez été invité s'affichent ci-dessous",
      profile_visibility:
      ...
      location_comment:
        "Indications supplémentaires pour aider les invités à trouver ce lieu",
      g1_tipjar_field:
    ...
    notification: {
      ...
      invitation_sent:
        "1 invitation envoyée |||| %{smart_count} invitations envoyées",
      ...
      app_not_authorized:
        "Application non-autorisée: impossible de rediriger vers l'URL %{url}",
